...
public class ArtworkPane extends Application{
	...
	private Pane AddHBox(){
		...
		animationPane.setSpacing(8);
		animationPane.setPadding(new Insets(4,4,4,4));
	    ...
	    Label lbl3 = new Label("Animation");
		objCount = new TextField();
		maxSize = new TextField();
		draw = new Button("Draw");	
	 	combobox.setValue("Circle");
	 	animationPane.getChildren().addAll(lbl3, playButton);
